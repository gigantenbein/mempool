...
#define MATCH_MWAIT_W 0x4800202f
#define MASK_MWAIT_W  0xf800707f
...
DECLARE_INSN(lrwait_w, MATCH_LRWAIT_W, MASK_LRWAIT_W)
DECLARE_INSN(scwait_w, MATCH_SCWAIT_W, MASK_SCWAIT_W)
DECLARE_INSN(mwait_w, MATCH_MWAIT_W, MASK_MWAIT_W)
